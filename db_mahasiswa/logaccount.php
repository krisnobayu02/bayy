...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        mysqli_query($koneksi, "INSERT INTO logdb_mahasiswa(user,username,password) 
        VALUES(
           '$user', '$username', '$pass')") or die(mysqli_error($koneksi));


        echo "<div align='center'><h5>Silahkan Tunggu, Data Sedang Disimpan.....<h5></div>";
        echo "<meta http=equiv='refresh' content='1;url=http://localhost/db_mahasiswa/index.php'>";
}
?>