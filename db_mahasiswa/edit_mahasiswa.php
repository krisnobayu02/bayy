...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        tanggal_lahir='$tanggal_lahir',jenis_kelamin='$jenis_kelamin',alamat='$alamat',kodepos='$kode_pos'
        WHERE npm='$id'") 
        or die(mysqli_error($koneksi));

            echo "<div align='center'><h5>Silahkan Tunggu, Data Sedang Diupdate....</h5></div>";
            echo "<meta http=equiv='refresh' content='1;url=http://localhost/db_mahasiswa/hasil_data_mahasiswa.php'>";
    }
?>